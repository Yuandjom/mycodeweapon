...
const CodeOutput = ({ judge0Error, isSubmitting, codeOutput, codeErrorId, codeErrorDesc, codeMemoryUsed, codeTimeUsed }: Props) => {
    return (
        <div className="w-full h-full space-y-4">
            {codeErrorId >= 5 && <div className="text-red-500 space-y-2">
            ...
            {judge0Error && <div className="text-red-500 space-y-2">
