    ...
    <div className="relative w-full overflow-hidden bg-background">
      <div className="relative flex flex-col items-center justify-center overflow-hidden px-8 pb-4 md:px-8">
        <div className="relative mt-20 flex flex-col items-center justify-center">
          ...
          <h2 className="font-regular relative mx-auto mb-8 mt-8 max-w-4xl text-center text-base tracking-wide text-zinc-500 antialiased md:text-xl dark:text-zinc-200">
            We enhance your leetcode experience with contextual AI assistance,
            helping you understand, solve, and master concepts faster.
          </h2>
        </div>
        <div className="group relative z-10 mb-16">
          <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6 text-white inline-block">
            <span className="absolute inset-0 overflow-hidden rounded-full">
              <span className="absolute inset-0 rounded-full bg-teal-600 opacity-20 group-hover:opacity-30 transition-opacity duration-500" />
            </span>
            <div className="relative flex space-x-2 items-center z-10 rounded-full py-0.5 px-4 ring-1 ring-green-500">
